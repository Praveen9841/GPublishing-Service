...
(function ($) {
  ...
  var rtsJs = {
    ...
    searchOption: function () {
      var searchOverlay = $(".search-input-area");
      var searchBackdrop = $("#anywhere-home");
      var searchInput = $(".search-input-area .search-input");
      var searchButton = $(".search-input-area button");

      $(document).on('click', '.search', function () {
        searchOverlay.addClass("show");
        searchBackdrop.addClass("bgshow");
      ...
      var closeSearch = function () {
        ...
        searchBackdrop.removeClass("bgshow");
      };

      $(document).on('click', '#close', closeSearch);
      $(document).on('click', '#anywhere-home', closeSearch);

      var performSearch = function () {
        if (!searchInput.length) return;
        var term = searchInput.val().trim().toLowerCase();
        var cards = $(".service-details-main-wrapper, .single-service-one, .single-service-two, .single-service-three, .single-service-four, .single-service-five");
